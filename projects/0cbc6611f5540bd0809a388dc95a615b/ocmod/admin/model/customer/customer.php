...
class ModelCustomerCustomer extends Model {
    ...
    public function getOrders($customer_id, $start = 0, $limit = 10) {
        ...
        $query = $this->db->query("
        SELECT o.order_id, o.date_added, o.date_modified, os.name as status, o.total, o.currency_code, o.currency_value
        FROM `" . DB_PREFIX . "order` o
          LEFT JOIN " . DB_PREFIX . "order_status os ON (o.order_status_id = os.order_status_id)
        WHERE o.customer_id = " . $this->db->escape($customer_id) . " AND o.order_status_id > '0'
    ...
    public function getTotalOrders($customer_id) {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "order o WHERE o.customer_id = '" . (int)$customer_id . "' AND o.order_status_id > '0'");
